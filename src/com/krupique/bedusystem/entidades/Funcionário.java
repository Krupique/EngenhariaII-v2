...
public class Funcionário
{
    ...
    public boolean alterar()
    {
        String sql = "update funcionario set func_nome = '$2', func_funcao = '$3', func_telefone = '$4',"
                ...
                + "func_sexo = $10, func_dtentrada = '$11' where func_codigo = $1";
        ...
        sql = sql.replace(codigo + "1", String.valueOf(entrada));
    ...
    public Funcionário get()
    {
        Funcionário f = new Funcionário();
        ResultSet rs = Banco.getCon().consultar("select * from funcionario where func_codigo = " + codigo);
    ...
    public ArrayList<Funcionário> getAll(String filtro,String campo)
    {
        ArrayList<Funcionário> funcionarios = new ArrayList<>();
        Funcionário f;
        ResultSet rs;
