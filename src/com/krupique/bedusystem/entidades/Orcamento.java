...
public class Orcamento 
{
    ...
    public Orcamento(Integer codigo, Date dtorcamento, Date dtvalidade, Double total, String obsformapagamento, Funcionário usuarioid, Cliente cliente, ArrayList<ItemOrcamentoProduto> produtosOrcamento, ArrayList<ItemOrcamentoServico> servicosOrcamento)
    {
        this.codigo = codigo;
    ...
    public Orcamento(Date dtorcamento, Date dtvalidade, Double total, String obsformapagamento, Funcionário usuarioid, Cliente cliente, ArrayList<ItemOrcamentoProduto> produtosOrcamento, ArrayList<ItemOrcamentoServico> servicosOrcamento)
    {
        this.dtorcamento = dtorcamento;
        this.dtvalidade = dtvalidade;
        this.total = total;
