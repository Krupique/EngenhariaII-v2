...
public class Fornecedor 
{
    ...
    public ArrayList<Fornecedor> buscar (String str)
    {
        ...
        try
        {
            ...
            while(rs.next())
                list.add(new Fornecedor(rs.getInt("forn_cod"), rs.getString("forn_cnpj"), rs.getString("forn_nome"), rs.getString("forn_telefone"), rs.getString("forn_email"), rs.getString("forn_rua"), rs.getString("forn_bairro"), rs.getInt("forn_num"), rs.getString("forn_cidade"), rs.getString("forn_cep")));
        }catch(Exception er)
        {
            System.out.println("Erro: " + er.getMessage());
        }
