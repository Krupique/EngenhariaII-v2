...
public class Veiculo
{
  ...
  private String vei_descricao ;
    ...
    public Veiculo(String vei_placa) {
        this.vei_placa = vei_placa;
    }
  ...
  // Date vei_ano ;String vei_cor ;String vei_descricao ;
    ...
    public void busca()
    {
        ResultSet rs = Banco.getCon().consultar("select * from veiculo where vei_placa = '" + vei_placa + "'");
        
        try
        {
            if(rs != null && rs.next())
            {
                this.setVei_ano(rs.getDate("vei_ano"));
                this.setVei_chassi(rs.getString("vei_chassi"));
                this.setVei_cor(rs.getString("vei_cor"));
                this.setVei_descricao(rs.getString("vei_descricao"));
                this.setVei_marca(rs.getString("vei_marca"));
                this.setVei_modelo(rs.getString("vei_modelo"));
            }
        } 
